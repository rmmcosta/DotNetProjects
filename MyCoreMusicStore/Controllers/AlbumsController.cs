...
namespace MyCoreMusicStore.Controllers
{
    public class AlbumsController : Controller
    {
        private readonly MyCoreMusicStoreDB _context;

        public AlbumsController(MyCoreMusicStoreDB context)
        {
            _context = context;
        }
        ...
        {
            var myCoreMusicStoreDB = _context.Album.Include(a => a.Artist).Include(a => a.Genre);
            return View(await myCoreMusicStoreDB.ToListAsync());
        }
